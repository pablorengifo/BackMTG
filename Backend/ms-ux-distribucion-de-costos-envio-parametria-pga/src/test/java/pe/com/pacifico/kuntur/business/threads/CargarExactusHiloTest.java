...
public class CargarExactusHiloTest {
  @Mock
  private CargarExactusHilo mockCargarExactusHilo = mock(CargarExactusHilo.class);

  @Mock
  private ExactusJpaRepository exactusJpaRepository = mock(ExactusJpaRepository.class);
  ...
  public void shouldCleanHilo() throws IOException {
    ...
    // When
    lenient().doNothing().when(mockCargarExactusHilo).start();
    // Then
    CargarExactusHilo.begin(repartoTipo, periodo, requestFileRead, exactusJpaRepository, dfsa, dfa);
  }
