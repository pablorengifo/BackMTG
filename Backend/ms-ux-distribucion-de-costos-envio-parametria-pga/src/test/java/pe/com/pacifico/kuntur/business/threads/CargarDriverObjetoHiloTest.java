...
public class CargarDriverObjetoHiloTest {

  @Mock
  private CargarDriverObjetoHilo mockCargarDriverObjetoHilo = mock(CargarDriverObjetoHilo.class);

  @Mock
  private MovDriverObjetoJpaRepository procesoJpaRepository = mock(MovDriverObjetoJpaRepository.class);
  ...
  public void shouldCleanHilo() throws IOException {
    ...
    // When
    lenient().doNothing().when(mockCargarDriverObjetoHilo).start();
    // Then
    CargarDriverObjetoHilo.begin(repartoTipo, periodo, requestFileRead, procesoJpaRepository, dfsa, dfa);
  }
}
