...
/**
 * <b>Class</b>: AsignacionCecoBolsaResponse <br/>
 ...
 * </ul>
 */
@ApiModel(description = "AsignacionCecoBolsaResponse model")
@AllArgsConstructor
@Builder
@Getter
@NoArgsConstructor
@Setter
@ToString
public class AsignacionCecoBolsaResponse implements Serializable {
  @Id
